...
//Inputs
#define LEFTMOTOR1 7//(Make sure this is not included in the motor groups below if not used)
#define LEFTMOTOR2 4//(Make sure this is not included in the motor groups below if not used)
#define LEFTMOTOR3 12//(Make sure this is not included in the motor groups below if not used)
#define LEFTMOTOR4 0//Set 0 because it is unused.(Make sure this is not included in the motor groups below if not used)
#define RIGHTMOTOR1 -6//(Make sure this is not included in the motor groups below if not used)
#define RIGHTMOTOR2 -19//(Make sure this is not included in the motor groups below if not used)
#define RIGHTMOTOR3 -5//(Make sure this is not included in the motor groups below if not used)
...
#define IMU_PORT1 2//Sets the 1st IMU PORT.
#define IMU_PORT2 20//Sets the 2nd IMU PORT.(Set 0 if unused)
