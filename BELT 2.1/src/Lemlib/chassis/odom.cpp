...
void lemlib::update() {
    ...
    if((odomSensors.imu != nullptr) && (odomSensors.imu2 != nullptr)) imuRaw = ((degToRad(odomSensors.imu->get_rotation()) + degToRad(odomSensors.imu2->get_rotation())) / 2);
    else if (odomSensors.imu != nullptr) imuRaw = degToRad(odomSensors.imu->get_rotation());
    else if (odomSensors.imu2 != nullptr) imuRaw = degToRad(odomSensors.imu2->get_rotation());
